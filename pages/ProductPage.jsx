  ...
  return (
    <Layout>
      ...
      <style>{`
        ...
        .variants-label { font-size:14px; font-weight:600; color:#444; margin-bottom:10px; text-transform:uppercase; }
        ...
        .variant-btn:hover { border-color:var(--primary); transform:translateY(-2px); }
        .variant-btn.active { border-color:var(--primary); background:#f0f4ff; box-shadow:0 0 0 3px rgba(0,43,91,0.15); }
        @media(max-width:768px){ .product-detail-container{flex-direction:column;} .pd-title{font-size:1.5rem;} }
      `}</style>
    </Layout>
  );
}
